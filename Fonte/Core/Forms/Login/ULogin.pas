...
begin
  if Trim(EdtLogin.Text) = '' then
    begin
      Atencao('Você esqueceu de informar o seu nome de Login');
      EdtLogin.SetFocus;
      Abort;
    end;
  ...
  if Trim(EdtSenha.Text) = '' then
    begin
      Atencao('Você esqueceu de informar a sua senha de Login');
      EdtSenha.SetFocus;
      Abort;
    end;
  ...
  with QryUsuar do
    begin
      ...
      if not IsEmpty then
        ...
        begin
          Atencao('Usuário ou Senha não foram reconhecido pelo sistema.'
          + #13 + 'Acesso negado');
          EdtLogin.SetFocus;
          abort;
        end;
