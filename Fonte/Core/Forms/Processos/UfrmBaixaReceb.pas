...
type
  TFrmCtRecebe = class(TFrmBasic)
    ...
    LblTitulo: TLabel;
    FDQryCtRecebCODIGO: TFDAutoIncField;
    FDQryCtRecebTITULO: TStringField;
    FDQryCtRecebPARCELA: TIntegerField;
    FDQryCtRecebVALOR: TBCDField;
    FDQryCtRecebJUROS: TBCDField;
    FDQryCtRecebMULTA: TBCDField;
